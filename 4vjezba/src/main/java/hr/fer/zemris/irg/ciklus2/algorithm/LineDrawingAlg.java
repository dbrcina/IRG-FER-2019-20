...
/**
 * Utility class which provides some line drawing algorithms.
 */
public class LineDrawingAlg {
     ...
     * @param line model of {@link ILine2D}.
     */
    public static void normalDrawLine(GL2 gl2, ILine2D line) {
        prepareColor(gl2, line.getColor());
        IPoint2D start = line.getStart();
        IPoint2D end = line.getEnd();
     ...
     * @param line model of {@link ILine2D}.
     */
    public static void bresenhamDrawLineI(GL2 gl2, ILine2D line) {
        prepareColor(gl2, line.getColor());
        IPoint2D start = line.getStart();
        IPoint2D end = line.getEnd();
